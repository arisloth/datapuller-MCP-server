...
- The spot trade tape is **venue-routed per symbol**: Binance, falling back to Bybit spot,
  then Hyperliquid spot for coins Binance doesn't list (probed once over REST, cached) —
  so Binance-unlisted coins still get a true trade-level spot CVD read.
